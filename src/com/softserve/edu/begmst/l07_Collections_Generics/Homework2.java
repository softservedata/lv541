package com.softserve.edu.begmst.l07_Collections_Generics;
import java.util.*;
...
public class Homework2 {
	...
	public static void main(String[] args) {
		...
		String[] names = {
				"Cristiano Ronaldo", "Lionel Messi", "Luka Modrić", "Antoine Griezmann", "Manuel Neuer", "Franck Ribéry", 
				"Andrés Iniesta", "Fernando Torres", "Gianluigi Buffon", "Fabio Cannavaro"
		};
		...
		Map<String, Integer> douplicates = doublicatedNames
			.entrySet()
			.stream()
