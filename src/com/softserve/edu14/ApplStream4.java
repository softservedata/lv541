...
public class ApplStream4 {
    ...
    public static void main(String[] args) {
        ...
        */
        /*-
        List<Stream<String>> strings = Arrays.asList(
                Arrays.asList("abc", "", "bc").stream(),
                Arrays.asList("eg", "abd", "", null, "jkl").stream());
        String result = strings.stream()
            .flatMap(Function.identity()) // Function.identity()
            .collect(Collectors.joining("*"));
